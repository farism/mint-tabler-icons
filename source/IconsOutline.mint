  ...
  module HeroIconsOutline {
    
  const ACADEMIC_CAP =

    <svg fill="none" viewBox="0 0 24 24" style="stroke-width: var(--heroicons-stroke-width, 1.5);" stroke="currentColor">
  ...
  const ARROW_LONG_DOWN =

    <svg fill="none" viewBox="0 0 24 24" style="stroke-width: var(--heroicons-stroke-width, 1.5);" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 17.25L12 21m0 0l-3.75-3.75M12 21V3"/>
    </svg>

  const ARROW_LONG_LEFT =
  ...
  const ARROW_PATH_ROUNDED_SQUARE =
  ...
  const ARROW_RIGHT_ON_RECTANGLE =
  ...
  const ARROW_SMALL_DOWN =

    <svg fill="none" viewBox="0 0 24 24" style="stroke-width: var(--heroicons-stroke-width, 1.5);" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75"/>
    </svg>

  const ARROW_SMALL_LEFT =

    <svg fill="none" viewBox="0 0 24 24" style="stroke-width: var(--heroicons-stroke-width, 1.5);" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 12h-15m0 0l6.75 6.75M4.5 12l6.75-6.75"/>
    </svg>

  const ARROW_SMALL_RIGHT =

    <svg fill="none" viewBox="0 0 24 24" style="stroke-width: var(--heroicons-stroke-width, 1.5);" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75"/>
    </svg>

  const ARROW_SMALL_UP =

    <svg fill="none" viewBox="0 0 24 24" style="stroke-width: var(--heroicons-stroke-width, 1.5);" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" d="M12 19.5v-15m0 0l-6.75 6.75M12 4.5l6.75 6.75"/>
    </svg>

  const ARROW_TOP_RIGHT_ON_SQUARE =

    <svg fill="none" viewBox="0 0 24 24" style="stroke-width: var(--heroicons-stroke-width, 1.5);" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25"/>
    </svg>

  const ARROW_TRENDING_DOWN =

    <svg fill="none" viewBox="0 0 24 24" style="stroke-width: var(--heroicons-stroke-width, 1.5);" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6L9 12.75l4.286-4.286a11.948 11.948 0 014.306 6.43l.776 2.898m0 0l3.182-5.511m-3.182 5.51l-5.511-3.181"/>
    </svg>

  const ARROW_TRENDING_UP =
  ...
  const BARS_3_BOTTOM_LEFT =

    <svg fill="none" viewBox="0 0 24 24" style="stroke-width: var(--heroicons-stroke-width, 1.5);" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12"/>
    </svg>

  const BARS_3_BOTTOM_RIGHT =

    <svg fill="none" viewBox="0 0 24 24" style="stroke-width: var(--heroicons-stroke-width, 1.5);" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5M12 17.25h8.25"/>
    </svg>

  const BARS_3_CENTER_LEFT =
  ...
  const CHEVRON_DOUBLE_DOWN =

    <svg fill="none" viewBox="0 0 24 24" style="stroke-width: var(--heroicons-stroke-width, 1.5);" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 5.25l-7.5 7.5-7.5-7.5m15 6l-7.5 7.5-7.5-7.5"/>
    </svg>

  const CHEVRON_DOUBLE_LEFT =

    <svg fill="none" viewBox="0 0 24 24" style="stroke-width: var(--heroicons-stroke-width, 1.5);" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" d="M18.75 19.5l-7.5-7.5 7.5-7.5m-6 15L5.25 12l7.5-7.5"/>
    </svg>

  const CHEVRON_DOUBLE_RIGHT =

    <svg fill="none" viewBox="0 0 24 24" style="stroke-width: var(--heroicons-stroke-width, 1.5);" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" d="M11.25 4.5l7.5 7.5-7.5 7.5m-6-15l7.5 7.5-7.5 7.5"/>
    </svg>

  const CHEVRON_DOUBLE_UP =
  ...
  const ELLIPSIS_HORIZONTAL_CIRCLE =

    <svg fill="none" viewBox="0 0 24 24" style="stroke-width: var(--heroicons-stroke-width, 1.5);" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
    </svg>

  const ELLIPSIS_HORIZONTAL =
  ...
  const MAGNIFYING_GLASS_CIRCLE =

    <svg fill="none" viewBox="0 0 24 24" style="stroke-width: var(--heroicons-stroke-width, 1.5);" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 15.75l-2.489-2.489m0 0a3.375 3.375 0 10-4.773-4.773 3.375 3.375 0 004.774 4.774zM21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
    </svg>

  const MAGNIFYING_GLASS_MINUS =

    <svg fill="none" viewBox="0 0 24 24" style="stroke-width: var(--heroicons-stroke-width, 1.5);" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607zM13.5 10.5h-6"/>
    </svg>

  const MAGNIFYING_GLASS_PLUS =
  ...
  const PRESENTATION_CHART_BAR =

    <svg fill="none" viewBox="0 0 24 24" style="stroke-width: var(--heroicons-stroke-width, 1.5);" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5M9 11.25v1.5M12 9v3.75m3-6v6"/>
    </svg>

  const PRESENTATION_CHART_LINE =
